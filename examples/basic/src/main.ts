...
// Run from examples/basic so basePath resolves src/commands, src/listeners, …
...
if (demo) {
  ...
  hub.emit("messageCreate", {
    id: "2",
    content: "!say hello basic",
    channelId: "c1",
    guildId: "g1",
    author: { id: "u1", bot: false },
  } satisfies StambhaMessage);
  // Allow async pipeline handlers to finish before stopping Chron / timers.
